...
h5open("oam3basic_basic.dat", "w") do fid
...
p,t,e = mainExperimentController(system_size, subsystem_dim,50000, string("./observables_entanglementWitness",subsystem_dim,"d.txt")) #"../observables_entanglementWitness",3,"d.txt"
